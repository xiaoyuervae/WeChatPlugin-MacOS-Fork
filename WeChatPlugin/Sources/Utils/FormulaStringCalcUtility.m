...
+ (NSString *)addV1:(NSString *)v1 v2:(NSString *)v2 {
    CGFloat result = [[v1 stringByTrimmingCharactersInSet:[[NSCharacterSet decimalDigitCharacterSet] invertedSet]] floatValue] + [[v2 stringByTrimmingCharactersInSet:[[NSCharacterSet decimalDigitCharacterSet] invertedSet]] floatValue];
